...
const Frame4 = () => {
  return (
    <View style={styles.eaInputBoxParent}>
      ...
      <Text style={[styles.lend, styles.lendPosition]}>Lend</Text>
      <Image
      ...
      <View style={[styles.homeRow, styles.homeLayout]}>
        ...
        />
        <View style={[styles.homeParent, styles.lendPosition]}>
      ...
      <View style={[styles.eyeParent, styles.inputLayout2]}>
        <Image
          style={styles.eyeIcon}
          contentFit="cover"
          source={require("../assets/eye.png")}
        />
        <Text style={[styles.text, styles.lendTypo]}>$23,000.06</Text>
        <Image
          style={[styles.groupChild, styles.groupChildLayout]}
          contentFit="cover"
          source={require("../assets/vector-111.png")}
        />
        <Text style={[styles.lendingHub, styles.lendTypo]}>Lending Hub</Text>
      </View>
      ...
      <View style={[styles.frameView, styles.frameViewLayout]}>
        <View style={[styles.eaInputBox3, styles.inputShadowBox]} />
      ...
      <View style={[styles.eaInputBoxParent1, styles.inputLayout]}>
        ...
        <Image
          style={[styles.lightningRingLightIcon, styles.groupInnerPosition]}
          contentFit="cover"
