  ...
  return (
    <View style={[styles.darhboardParent, style]}>
      <View style={[styles.darhboard, styles.farmsPosition]}>
        ...
        <View style={[styles.darhboardItem, styles.darhboardPosition1]} />
        <View style={[styles.darhboardInner, styles.rectangleViewLayout1]} />
        <View style={[styles.rectangleView, styles.rectangleViewLayout1]} />
      </View>
